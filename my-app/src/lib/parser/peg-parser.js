...
function peg$parse(input, options) {
  ...
  function peg$parseexpresionConcat() {
    var s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseexpresion() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseexpresionCuenatificada();
    if (s1 !== peg$FAILED) {
  ...
  function peg$parseexpresionCuenatificada() {
    var s0, s1, s2, s3, s4, s5;
